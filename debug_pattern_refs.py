#!/usr/bin/env python3
"""Advanced debug script to analyze pattern reference table structure in NES ROM."""
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python debug_pattern_refs.py <rom_file>")
        sys.exit(1)
    
    rom_file = sys.argv[1]
    analyze_pattern_refs(rom_file)
