...
class CA65Exporter(BaseExporter):
    ...
    def export_tables_with_patterns(self, frames, patterns, references, output_path):
        lines = []
        lines.append("; CA65 Assembly Export (Pattern Compressed)")
        lines.append("; Generated by MIDI2NES")
        lines.append("")
        lines.append(".importzp ptr1, temp1, temp2, frame_counter")  # Import zero-page variables
        lines.append("")
        lines.append(".export init_music")  # Export as absolute address
        lines.append(".export update_music")  # Export as absolute address
        lines.append("")
