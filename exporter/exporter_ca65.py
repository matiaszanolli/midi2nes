...
class CA65Exporter(BaseExporter):
    ...
    def export_tables_with_patterns(self, frames, patterns, references, output_path, standalone=True):
        ...
        lines.extend([
            ...
            "init_music:",
            "    ; Initialize APU with proper audio setup",
            "    lda #$0F",
            ...
            "    lda #$00",
            "    sta $4005   ; No sweep",
            "    ; Set up Triangle (enabled, linear counter enabled)",
            "    lda #$80",
            "    sta $4008   ; Linear counter control",
            ...
            "    lda temp2",
            "    cmp #$00",
            "    beq @play_silent  ; If volume is 0, silence channel",
            "    ; Set up pulse 1 with duty cycle + volume",
            "    ora #$B0      ; 50% duty + constant volume + volume from temp2",
            "    sta $4000     ; Set duty/volume",
            "    txa",
            "    sta $4002     ; Set timer low",
            "    tya",
            "    ora #$08      ; Reset length counter",
            "    sta $4003     ; Set timer high + length reset",
            "    rts",
            "@play_silent:",
            "    lda #$30      ; 50% duty, constant vol, but volume=0",
            "    sta $4000",
            "    rts"
        ])
